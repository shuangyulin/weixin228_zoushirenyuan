<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiashu'"  label="用户名" prop="yonghuming">
          <el-input v-model="ruleForm.yonghuming" readonly              placeholder="用户名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiashu'"  label="姓名" prop="xingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiashu'"  label="手机" prop="shouji">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="账号" prop="zhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='gonganbumen'"  label="部门账号" prop="bumenzhanghao">
          <el-input v-model="ruleForm.bumenzhanghao" readonly              placeholder="部门账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='gonganbumen'"  label="负责人" prop="fuzeren">
          <el-input v-model="ruleForm.fuzeren"               placeholder="负责人" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='gonganbumen'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          ...
          @change="gonganbumenzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='gonganbumen'"  label="联系电话" prop="lianxidianhua">
...
export default {
  ...
  methods: {
    ...
    gonganbumenzhaopianUploadChange(fileUrls) {
        this.ruleForm.zhaopian = fileUrls;
    },
    onUpdateHandler() {
      if((!this.ruleForm.yonghuming)&& 'jiashu'==this.flag){
      ...
      if((!this.ruleForm.xingming)&& 'jiashu'==this.flag){
      ...
      if( 'jiashu' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
      ...
      if((!this.ruleForm.zhanghao)&& 'zhiyuanzhe'==this.flag){
      ...
      if((!this.ruleForm.bumenzhanghao)&& 'gonganbumen'==this.flag){
        this.$message.error('部门账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'gonganbumen'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
