<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">微信小程序的走失人员的报备平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='jiashu'" class="input-group">
			   <div class="label">用户名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuming" class="input" type="text" placeholder="用户名">
			   </div>
			 </div> -->
			<el-form-item label="用户名" class="input" v-if="tableName=='jiashu'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiashu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jiashu'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='jiashu'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='jiashu'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='jiashu'">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='zhiyuanzhe'">
			...
			<!-- <div v-if="tableName=='gonganbumen'" class="input-group">
			   <div class="label">部门账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.bumenzhanghao" class="input" type="text" placeholder="部门账号">
			   </div>
			 </div> -->
			<el-form-item label="部门账号" class="input" v-if="tableName=='gonganbumen'">
			  <el-input v-model="ruleForm.bumenzhanghao" autocomplete="off" placeholder="部门账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='gonganbumen'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='gonganbumen'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='gonganbumen'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='gonganbumen'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='gonganbumen'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `jiashu` == this.tableName){
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `gonganbumen` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      this.$http({
