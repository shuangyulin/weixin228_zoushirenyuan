...
public class JiashuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiashuEntity user = jiashuService.selectOne(new EntityWrapper<JiashuEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody JiashuEntity jiashu){
    	...
    	JiashuEntity user = jiashuService.selectOne(new EntityWrapper<JiashuEntity>().eq("yonghuming", jiashu.getYonghuming()));
		if(user!=null) {
